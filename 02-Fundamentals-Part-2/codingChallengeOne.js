...
/*
Back to the two gymastics teams, the Dolphins and the Koalas! There is a new gymastics discipline, which works differently.
...
3. Create a function 'checkWinner' that takes the average score of each team as parameters ('avgDolphins' and 'avgKoalas'), 
   and the logs the winner to the console, together with the victory points, according to the rule above. 
